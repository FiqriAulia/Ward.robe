$(() => {
    ...
    $(document).ready(function () {
        $('h2').click(function () {
            ...
            if (classClicked.toLowerCase() == "install") {
                window.location.href = '../wardrobe/asset/txt/install.txt';
            }else{window.location.href = '../wardrobe/main/v_' + textClicked.toLowerCase() + '.php';}
        });
    });
    $(document).ready(function () {
        $('h4').click(function () {
